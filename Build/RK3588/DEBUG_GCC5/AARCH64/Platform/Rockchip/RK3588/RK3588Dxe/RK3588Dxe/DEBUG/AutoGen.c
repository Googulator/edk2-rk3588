...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xf6c64348, 0x45ec, 0x11ec, {0x97, 0x26, 0xf4, 0x2a, 0x7d, 0xcb, 0x92, 0x5d}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "RK3588Dxe";
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gRK3588TokenSpaceGuid = { 0xaad4eac0, 0x45e7, 0x11ec, { 0x95, 0xb4, 0xf4, 0x2a, 0x7d, 0xcb, 0x92, 0x5d } };
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gAndroidBootImgProtocolGuid = { 0x9859bb19, 0x407c, 0x4f8b, {0xbc, 0xe1, 0xf8, 0xda, 0x65, 0x65, 0xf4, 0xa5 }};
...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT16 _gPcd_FixedAtBuild_PcdAndroidBootDevicePath[26] = {92, 69, 70, 73, 92, 66, 79, 79, 84, 92, 71, 82, 85, 66, 65, 65, 54, 52, 46, 69, 70, 73, 0 };
GLOBAL_REMOVE_IF_UNREFERENCED const UINTN _gPcd_FixedAtBuild_Size_PcdAndroidBootDevicePath = 52;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT8 _gPcd_FixedAtBuild_PcdAndroidBootFile[16] = { 0x36, 0x8b, 0x73, 0x3a, 0xc5, 0xb9, 0x63, 0x47, 0xab, 0xbd, 0x6c, 0xbd, 0x4b, 0x25, 0xf9, 0xff };
GLOBAL_REMOVE_IF_UNREFERENCED const UINTN _gPcd_FixedAtBuild_Size_PcdAndroidBootFile = 16;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT8 _gPcd_FixedAtBuild_PcdAndroidFastbootFile[16] = { 0x2a, 0x50, 0x88, 0x95, 0x70, 0x53, 0xe3, 0x11, 0x86, 0x31, 0xd7, 0xc5, 0x95, 0x13, 0x64, 0xc8 };
GLOBAL_REMOVE_IF_UNREFERENCED const UINTN _gPcd_FixedAtBuild_Size_PcdAndroidFastbootFile = 16;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT16 _gPcd_FixedAtBuild_PcdSdBootDevicePath[71] = {86, 101, 110, 72, 119, 40, 48, 68, 53, 49, 57, 48, 53, 66, 45, 66, 55, 55, 69, 45, 52, 53, 50, 65, 45, 65, 50, 67, 48, 45, 69, 67, 65, 48, 67, 67, 56, 68, 53, 49, 52, 65, 44, 48, 48, 69, 48, 50, 51, 70, 55, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 41, 47, 83, 68, 40, 48, 120, 48, 41, 0 };
GLOBAL_REMOVE_IF_UNREFERENCED const UINTN _gPcd_FixedAtBuild_Size_PcdSdBootDevicePath = 142;
GLOBAL_REMOVE_IF_UNREFERENCED const BOOLEAN _gPcd_FixedAtBuild_AcpiEnable = _PCD_VALUE_AcpiEnable;
...
#define _PCD_VALUE_PcdSdhciDxeBaseAddress  0xfe2e0000U
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdSdhciDxeBaseAddress = _PCD_VALUE_PcdSdhciDxeBaseAddress;
...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdI2cBusCount = _PCD_VALUE_PcdI2cBusCount;
...
#define _PCD_VALUE_SpiRK806BaseAddr  0xFEB20000U
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_SpiRK806BaseAddr = _PCD_VALUE_SpiRK806BaseAddr;
...
{
  return RK3588EntryPoint (ImageHandle, SystemTable);
}
