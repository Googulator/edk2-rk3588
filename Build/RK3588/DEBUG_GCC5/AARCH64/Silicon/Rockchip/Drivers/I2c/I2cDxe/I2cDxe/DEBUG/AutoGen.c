...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x9335a854, 0x4b88, 0x11ec, {0xa8, 0xee, 0xf4, 0x2a, 0x7d, 0xcb, 0x92, 0x5d}};
...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT8 _gPcd_FixedAtBuild_PcdI2cSlaveAddresses[1] = { 0x51 };
GLOBAL_REMOVE_IF_UNREFERENCED const UINTN _gPcd_FixedAtBuild_Size_PcdI2cSlaveAddresses = 1;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT8 _gPcd_FixedAtBuild_PcdI2cSlaveBuses[1] = { 0x2 };
GLOBAL_REMOVE_IF_UNREFERENCED const UINTN _gPcd_FixedAtBuild_Size_PcdI2cSlaveBuses = 1;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT8 _gPcd_FixedAtBuild_PcdI2cControllersEnabled[1] = { 0x2 };
GLOBAL_REMOVE_IF_UNREFERENCED const UINTN _gPcd_FixedAtBuild_Size_PcdI2cControllersEnabled = 1;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdI2cClockFrequency = _PCD_VALUE_PcdI2cClockFrequency;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdI2cBaudRate = _PCD_VALUE_PcdI2cBaudRate;
...
{
  return I2cInitialise (ImageHandle, SystemTable);
}
