...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x59fc3843, 0xd8d4, 0x40aa, {0xae, 0x07, 0x38, 0x96, 0x71, 0x38, 0x50, 0x9c}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "I2cDemoDxe";
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gRockchipI2cDemoProtocolGuid = { 0x71954bda, 0x60d3, 0x4ef8, { 0x8e, 0x3c, 0x0e, 0x33, 0x9f, 0x3b, 0xc2, 0x2b }};
...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT8 _gPcd_FixedAtBuild_PcdI2cDemoAddresses[1] = { 0x51 };
GLOBAL_REMOVE_IF_UNREFERENCED const UINTN _gPcd_FixedAtBuild_Size_PcdI2cDemoAddresses = 1;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT8 _gPcd_FixedAtBuild_PcdI2cDemoBuses[1] = { 0x2 };
GLOBAL_REMOVE_IF_UNREFERENCED const UINTN _gPcd_FixedAtBuild_Size_PcdI2cDemoBuses = 1;
...
{
  return I2cDemoInitialise (ImageHandle, SystemTable);
}
