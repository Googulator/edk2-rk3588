...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xdf325b7e, 0xae7c, 0x11ec, {0xa1, 0x54, 0xf4, 0x2a, 0x7d, 0xcb, 0x92, 0x5d}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "RkFvbDxe";
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gRockchipSpiFlashProtocolGuid = {0x339132DC, 0xCED7, 0x4f84, {0xAA, 0xE7, 0x2E, 0xC4, 0xF9, 0x14, 0x38, 0x2F}};
...
{
  return RkFvbEntryPoint (ImageHandle, SystemTable);
}
