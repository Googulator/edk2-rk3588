...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xce7de226, 0xae7c, 0x11ec, {0xa1, 0x54, 0xf4, 0x2a, 0x7d, 0xcb, 0x92, 0x5d}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "NorFlashDxe";
...
// Protocols
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gUniNorFlashProtocolGuid = {0x86F305EA, 0xDFAC, 0x4A6B, {0x92, 0x77, 0x47, 0x31, 0x2E, 0xCE, 0x42, 0xA}};
...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_FspiBaseAddr = _PCD_VALUE_FspiBaseAddr;
...
{
  return InitializeFlash (ImageHandle, SystemTable);
}
