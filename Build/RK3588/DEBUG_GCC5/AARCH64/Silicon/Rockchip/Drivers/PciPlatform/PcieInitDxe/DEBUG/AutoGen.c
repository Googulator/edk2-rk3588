...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x8EB6E216, 0xBA47, 0x4B30, {0xB6, 0x8A, 0x2B, 0x37, 0x1F, 0x72, 0x32, 0xA6}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "PcieInitDxe";
...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT64 _gPcd_FixedAtBuild_PcdPcieRootPortApbBaseAddress = _PCD_VALUE_PcdPcieRootPortApbBaseAddress;
...
{
  return PcieInitEntry (ImageHandle, SystemTable);
}
