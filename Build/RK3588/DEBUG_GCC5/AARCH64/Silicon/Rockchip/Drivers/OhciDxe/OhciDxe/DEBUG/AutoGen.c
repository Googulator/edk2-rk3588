...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x3914AE34, 0xB946, 0x11EC, {0x9D, 0x33, 0xF4, 0x2A, 0x7D, 0xCB, 0x92, 0x5D}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "OhciDxe";
...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdOhciBaseAddress = _PCD_VALUE_PcdOhciBaseAddress;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdOhciSize = _PCD_VALUE_PcdOhciSize;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdNumOhciController = _PCD_VALUE_PcdNumOhciController;
...
{
  return OhciInitialise (ImageHandle, SystemTable);
}
