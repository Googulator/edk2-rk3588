...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x1cbb3666, 0x99fe, 0x11ec, {0x99, 0x27, 0xf4, 0x2a, 0x7d, 0xcb, 0x92, 0x5d}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "Vop2Dxe";
...
{
  return Vop2DxeInitialize (ImageHandle, SystemTable);
}
