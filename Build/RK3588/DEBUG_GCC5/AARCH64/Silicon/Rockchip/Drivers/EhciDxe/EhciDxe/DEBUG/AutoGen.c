...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x1AA6BD7A, 0xB946, 0x11EC, {0x9D, 0x33, 0xF4, 0x2A, 0x7D, 0xCB, 0x92, 0x5D}};
...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdEhciBaseAddress = _PCD_VALUE_PcdEhciBaseAddress;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdNumEhciController = _PCD_VALUE_PcdNumEhciController;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdEhciSize = _PCD_VALUE_PcdEhciSize;
...
{
  return EhciInitialise (ImageHandle, SystemTable);
}
