...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gShellI2cDemoHiiGuid = { 0xb2f4c714, 0x147f, 0x4ff7, { 0x82, 0x1b, 0xce, 0x7b, 0x91, 0x7f, 0x5f, 0x2f } };
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gShellSfHiiGuid = { 0x03a67756, 0x8cde, 0x4638, { 0x82, 0x34, 0x4a, 0x0f, 0x6d, 0x58, 0x81, 0x39 } };
  ...
  )
{
  ...
  Status = ShellI2cDemoTestLibConstructor (ImageHandle, SystemTable);
  ASSERT_EFI_ERROR (Status);

  Status = ShellSpiFlashLibConstructor (ImageHandle, SystemTable);
  ASSERT_EFI_ERROR (Status);
  ...
  )
{
  ...
  Status = ShellSpiFlashLibDestructor (ImageHandle, SystemTable);
  ASSERT_EFI_ERROR (Status);

  Status = ShellI2cDemoTestLibDestructor (ImageHandle, SystemTable);
  ASSERT_EFI_ERROR (Status);
