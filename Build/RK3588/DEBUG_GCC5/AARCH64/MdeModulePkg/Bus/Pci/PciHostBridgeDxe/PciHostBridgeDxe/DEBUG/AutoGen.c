...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT64 _gPcd_FixedAtBuild_PcdPcieRootPortDbiBaseAddress = _PCD_VALUE_PcdPcieRootPortDbiBaseAddress;
...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT64 _gPcd_FixedAtBuild_PcdPcieRootPortCfgBaseAddress = _PCD_VALUE_PcdPcieRootPortCfgBaseAddress;
...
#define _PCD_VALUE_PcdPcieRootPortMemSize  0xe00000U
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdPcieRootPortMemSize = _PCD_VALUE_PcdPcieRootPortMemSize;
...
#define _PCD_VALUE_PcdPcieRootPortMemBaseAddress  0xf0200000U
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdPcieRootPortMemBaseAddress = _PCD_VALUE_PcdPcieRootPortMemBaseAddress;
...
#define _PCD_VALUE_PcdPcieRootPortMemBaseAddress64  0x900000000ULL
GLOBAL_REMOVE_IF_UNREFERENCED const UINT64 _gPcd_FixedAtBuild_PcdPcieRootPortMemBaseAddress64 = _PCD_VALUE_PcdPcieRootPortMemBaseAddress64;
...
#define _PCD_VALUE_PcdPcieRootPortMemSize64  0x40000000ULL
GLOBAL_REMOVE_IF_UNREFERENCED const UINT64 _gPcd_FixedAtBuild_PcdPcieRootPortMemSize64 = _PCD_VALUE_PcdPcieRootPortMemSize64;
...
#define _PCD_VALUE_PcdPcieRootPortIoSize  0x100000U
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdPcieRootPortIoSize = _PCD_VALUE_PcdPcieRootPortIoSize;
...
#define _PCD_VALUE_PcdPcieRootPortIoBaseAddress  0xf0100000U
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdPcieRootPortIoBaseAddress = _PCD_VALUE_PcdPcieRootPortIoBaseAddress;
...
#define _PCD_VALUE_PcdPciIoBase  0x0ULL
GLOBAL_REMOVE_IF_UNREFERENCED const UINT64 _gPcd_FixedAtBuild_PcdPciIoBase = _PCD_VALUE_PcdPciIoBase;
...
#define _PCD_VALUE_PcdPciIoSize  0x0ULL
GLOBAL_REMOVE_IF_UNREFERENCED const UINT64 _gPcd_FixedAtBuild_PcdPciIoSize = _PCD_VALUE_PcdPciIoSize;
