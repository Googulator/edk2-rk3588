...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x3a738b36, 0xb9c5, 0x4763, {0xab, 0xbd, 0x6c, 0xbd, 0x4b, 0x25, 0xf9, 0xff}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "AndroidBootApp";
...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT16 _gPcd_FixedAtBuild_PcdAndroidBootDevicePath[106] = {86, 101, 110, 72, 119, 40, 49, 48, 48, 67, 50, 67, 70, 65, 45, 66, 53, 56, 54, 45, 52, 49, 57, 56, 45, 57, 66, 52, 67, 45, 49, 54, 56, 51, 68, 49, 57, 53, 66, 49, 68, 65, 41, 47, 72, 68, 40, 51, 44, 71, 80, 84, 44, 55, 65, 51, 70, 48, 48, 48, 48, 45, 48, 48, 48, 48, 45, 52, 52, 54, 65, 45, 56, 48, 48, 48, 45, 55, 48, 50, 70, 48, 48, 48, 48, 54, 50, 55, 51, 44, 48, 120, 56, 48, 48, 48, 44, 48, 120, 52, 48, 48, 48, 48, 41, 0 };
GLOBAL_REMOVE_IF_UNREFERENCED const UINTN _gPcd_FixedAtBuild_Size_PcdAndroidBootDevicePath = 212;
...
#define _PCD_SIZE_PcdAndroidBootLoadFile2 1
#define _PCD_GET_MODE_SIZE_PcdAndroidBootLoadFile2  _PCD_SIZE_PcdAndroidBootLoadFile2 
#define _PCD_VALUE_PcdAndroidBootLoadFile2  ((BOOLEAN)0U)
GLOBAL_REMOVE_IF_UNREFERENCED const BOOLEAN _gPcd_FixedAtBuild_PcdAndroidBootLoadFile2 = _PCD_VALUE_PcdAndroidBootLoadFile2;
...
{
  return AndroidBootAppEntryPoint (ImageHandle, SystemTable);
}
