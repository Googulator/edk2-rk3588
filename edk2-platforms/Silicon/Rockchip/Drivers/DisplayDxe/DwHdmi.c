...
#include "Vop2.h"
#include "DwHdmi.h"
#include <IndustryStandard/Rk358x.h>
...
/* RK358x specific GRF registers */
#define GRF_VO1_CON3         (SYS_GRF + 0x0364)
#define  HDMI_SDAIN_MSK     BIT10
#define  HDMI_SCLIN_MSK     BIT9

#define IOMUX_HDMITX_FUNC   5

/* HDMI TX registers */
#define HDMI_REG(x)         (HDMI0_BASE + ((x) * 4))
    ...
    )
{
    ...
    MmioWrite32 (GRF_VO1_CON3, Mask | Val);

    /* hdmitxm0_cec */
    GpioPinSetFunction (4, GPIO_PIN_PC1, IOMUX_HDMITX_FUNC);
    GpioPinSetPull (4, GPIO_PIN_PC1, GPIO_PIN_PULL_NONE);

    /* hdmitx_scl */
    GpioPinSetFunction (4, GPIO_PIN_PB7, IOMUX_HDMITX_FUNC);
    GpioPinSetPull (4, GPIO_PIN_PB7, GPIO_PIN_PULL_NONE);

    /* hdmitx_sda */
    GpioPinSetFunction (4, GPIO_PIN_PC0, IOMUX_HDMITX_FUNC);
